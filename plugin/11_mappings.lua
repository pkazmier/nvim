...
-- TODO: Look at the rest of echas bindings.
...
map({"n","x","o"}, "S",         C"lua Config.leap_treesitter_select()",  "Treesitter select")
...
map("n", L"mdu", C"DepsUpdate",                                         "Update deps")
...
map("n", L"st",  C"Pick grep_todo_keywords",                            "Search Todo/Note")
