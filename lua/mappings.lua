...
nmap(L"ba",  C"b#",                                               "Alternate buffer")
...
nmap(L"gb",  C"vertical Git blame -- %",                          "Git history")
...
nmap(L"gl",  C"Git hist",                                         "Git history")
nmap(L"gL",  C"Git hist --all",                                   "Git history (all)")
...
nmap(L"mf",  C"lua MiniMap.toggle_focus()",                       "Focus")
nmap(L"mr",  C"lua MiniMap.refresh()",                            "Refresh")
nmap(L"ms",  C"lua MiniMap.toggle_side()",                        "Switch sides")
nmap(L"mt",  C"lua require('plugins.mini.map').toggle()",         "Toggle map")
nmap(L"mT",  C"lua require('plugins.mini.map').buf_toggle()",     "Toggle map (buf)")
...
nmap(L"qt",  C"Pick colorschemes",                                "Pick colorschemes")
